...
const About1 = ({
    ...
    return (
        <section className="cs_about cs_style_1" style={{ backgroundColor: '#f8f9fa' }}>
                    ...
                    <div className="col-xl-6">
                        <div className="cs_about_thumbnail_wrapper position-relative">
                            {/* <div className="cs_about_thumbnail">
                                <img src={img1} alt={t('about.title')} />
                            </div>
                            <div className="cs_about_thumbnail">
                                <img src={img2} alt={t('about.title')} />
                            </div>
                            <div className="cs_about_thumbnail">
                                <img src={img3} alt={t('about.title')} />
                            </div> */}
                            <div className="cs_esperience_text position-absolute">
                                <h2 className="cs_experience_title mb-0">
                                    ...
                                    {/* <span className="cs_fs_50 cs_accent_color">{t('about.experience')}</span> */}
                                </h2>
                            </div>
                        ...
                        <div className="cs_about_text">
                            <div className="cs_section_heading cs_style_1 cs_mb_20">
                                <h3 className="cs_section_subtitle cs_fs_18 cs_accent_color cs_semibold text-uppercase cs_mb_12 wow fadeInDown">
                                    ...
                                    </svg> {t('about.subtitle')}</h3>
                                <h2 className="cs_section_title cs_fs_50 mb-0 wow fadeInUp">{t('about.title')}</h2>
                            </div>
                            <p className="cs_mb_40">{t('about.description')}</p>
                            {/*<div className="cs_features_list cs_mb_32">
                                 <div className="cs_iconbox cs_style_1">
                                     <div className="cs_iconbox_icon cs_center">
                                        <img src="/assets/img/icons/quick-fix.svg" alt={t('about.mission')} />
                                    </div> *
                                    <h3 className="cs_iconbox_title cs_fs_24 cs_semibold mb-0">{t('about.mission')}</h3>
                                </div> */}
                                {/* <div className="cs_iconbox cs_style_1">
                                    <div className="cs_iconbox_icon cs_center">
                                        <img src="/assets/img/icons/quick-fix.svg" alt={t('about.vision')} />
                                    </div>
                                    <h3 className="cs_iconbox_title cs_fs_24 cs_semibold mb-0">{t('about.vision')}</h3>
                                </div> 
                            </div>*/}
